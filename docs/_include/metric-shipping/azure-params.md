...
| fields.token | Your Metrics account token. {@include: ../_include/metric-shipping/replace-metrics-token.html} |
| output.logstash.hosts | Your Logz.io listener host. {@include: ../_include/log-shipping/listener-var.html}  |
