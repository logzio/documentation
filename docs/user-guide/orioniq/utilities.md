...
The Logz.io utility is connected by default and provides agents with access to your observability data via the Logz.io API.

To request access to additional utilities, click **Add to Wish List** on the utility you're interested in. This helps Logz.io prioritize which integrations to support next.
