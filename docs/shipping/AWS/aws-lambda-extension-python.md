---
id: Lambda-extension-python
title: Traces from Python on AWS Lambda using OpenTelemetry
overview: This integration to auto-instrument your Python application running on AWS Lambda and send the traces to your Logz.io account.
product: ["tracing"]
os: ["windows", "linux"]
filters: ["AWS", "Compute"]
