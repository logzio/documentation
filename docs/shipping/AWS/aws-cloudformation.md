...
These templates allow shipping CloudFormation AWS Logs and Metrics to logz.io.
...
- AWS logs to Logz.io [See here the function's repo](https://github.com/logzio/firehose-logs).
...
Deploy this integration to send your Cloudformation metrics to Logz.io.

This integration creates a Kinesis Data Firehose delivery stream that links to your Amazon Cloudformation metrics stream and then sends the metrics to your Logz.io account. It also creates a Lambda function that adds AWS namespaces to the metric stream, and a Lambda function that collects and ships the resources' tags.
