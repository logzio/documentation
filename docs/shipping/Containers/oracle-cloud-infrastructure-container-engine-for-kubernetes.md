...
```shell
kubectl apply -f https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/k8s-filebeat-oke.yaml -f https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/filebeat-standard-configuration.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/k8s-filebeat-oke.yaml -f https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/filebeat-autodiscovery-configuration.yaml
```

##### Deploy a custom configuration

If you want to apply your own custom configuration, download the standard `configmap.yaml` file from the [Logz.io GitHub repo](https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/filebeat-standard-configuration.yaml) and apply your changes. Make sure to keep the file structure unchanged.

Run the following command to download the file:

```shell
wget https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/filebeat-standard-configuration.yaml
```
...
```shell
kubectl apply -f https://raw.githubusercontent.com/logzio/docs/_include/shipping-config-samples/k8s-filebeat-oke.yaml -f <<Your-custom-configuration-file.yaml>>
```
