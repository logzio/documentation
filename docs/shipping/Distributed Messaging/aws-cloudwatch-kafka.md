---
id: AWS-Cloudwatch-Kafka
title: AWS Cloudwatch Kafka
overview: Send your Amazon Cloudwatch Kafka metrics to Logz.io.
product: ['metrics']
os: ['windows', 'linux']
...
Deploy this integration to send your Amazon Cloudwatch Kafka metrics to Logz.io.

This integration creates a Kinesis Data Firehose delivery stream that links to your Amazon Cloudwatch Kafka metrics stream and then sends the metrics to your Logz.io account. It also creates a Lambda function that adds AWS namespaces to the metric stream, and a Lambda function that collects and ships the resources' tags.
