---
sidebar_position: 2
title: Logz.io advanced features
---
...
* [Manage your workspace with Sub accounts and Flexible volume
* [Optimize log data with Drop filters & Archive and restore
* [Optimize metrics data
* [Utilize data analytics with:
  * [Alerts
  * [Patterns engine
  * [Usage calculation
...
Logz.io offers a centralized solution, including all the tools and elements needed to gain observability into your data. You can create a **[Sub account** to help manage usage, volume, and access to the data.
...
* If you want to look back at logs outside your retention period with Logz.io, you can [reingest that data into the platform for deeper analysis. 
* Cost-effective. Data you reingest to Logz.io from your archive does not count against your daily quota. 

We know that sometimes you just need to have logs searchable for more extended periods of time, which is why we created **[Smart tiering**, which allows you to reduce storage costs as data ages. 

* [Learn how to set up your Drop filters.
* [Learn how to set up your Archive and restore.
